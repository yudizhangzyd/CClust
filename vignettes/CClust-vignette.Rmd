...
datFile <- "../inst/extdata/sim.fastq"
...
datFile <- "../inst/extdata/zoo.int.data"
...
datFile <- "../inst/extdata/sim.fastq"
res_khap <- khaplotype (K = 5, datafile = datFile, n_init = 3)
ass <- "../inst/extdata/assignment.txt"
...
data <- "../inst/extdata/zoo.int.data"

...
#define SETZERO_1ARRAY(a,n) do {                                             \
	for (size_t ARRAY_H1RESERVED = 0; ARRAY_H1RESERVED < n;              \
							++ARRAY_H1RESERVED)  \
...
#define SETZERO_2ARRAY(a, n) do {                                            \
	for (size_t ARRAY_H2RESERVED = 0; (a)[ARRAY_H2RESERVED] != NULL;     \
		ARRAY_H2RESERVED++)                                          \
		SETZERO_1ARRAY((a)[ARRAY_H2RESERVED], n);                    \
} while (0)
...
#define SETZERO_3ARRAY(a, r) do {                                              \
	size_t ARRAY_H3RESERVED;                                               \
	for (ARRAY_H3RESERVED = 0; (a)[ARRAY_H3RESERVED] != NULL;              \
		ARRAY_H3RESERVED++) {                                          \
		SETZERO_2ARRAY((a)[ARRAY_H3RESERVED], (r));                    \
	}                                                                      \
} while (0)
